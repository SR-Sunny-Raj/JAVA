...
// System.out.println("Enter the item details in the format(Item Name$Item
// Type$Item Cost$Item Availability");
...
// Item item = new Item(input[0], input[1], Integer.parseInt(input[2]),
